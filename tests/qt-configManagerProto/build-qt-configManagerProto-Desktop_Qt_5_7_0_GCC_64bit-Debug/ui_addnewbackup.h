...
public:
    ...
    void setupUi(QDialog *AddNewBackup)
    {
        ...
        newSaveButtonBox = new QDialogButtonBox(layoutWidget);
        ...
        QObject::connect(newSaveButtonBox, SIGNAL(accepted()), AddNewBackup, SLOT(accept()));
        QObject::connect(newSaveButtonBox, SIGNAL(rejected()), AddNewBackup, SLOT(reject()));
