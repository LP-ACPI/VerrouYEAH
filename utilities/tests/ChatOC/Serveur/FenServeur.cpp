...
/**
 *      Constructeur de la fenêtre du serveur
 *
 * @brief FenServeur::FenServeur
 */
FenServeur::FenServeur()
{
    ...
    setWindowTitle(tr("ChatOC - Serveur"));
...
/**
 * Rôle: Initialiser une connexion au serveur - instancier un client et le placer à un socket TCP
 *
 * @brief FenServeur::nouvelleConnexion
 *
 */
...
/**
 * Rôle: Gestion des données reçues par le serveur via le socket
 *
 * @brief FenServeur::donneesRecues
 */
...
/**
 * Rôle: gestion de déconnexion d'un client et fermeture de son socket
 *
 * @brief FenServeur::deconnexionClient
 */
...
/**
 * Rôle: communiquer un broadcast
 *
 * @brief FenServeur::envoyerATous
 *  @param message
 */
